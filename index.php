...
case "tarif":
  ...
  $tarif_blank = '
<tbody><tr><th>Сервисы</th><th class="tarif_table_column">Бесплатный</th><th class="tarif_table_column">Стандарт</th><th class="tarif_table_column">VIP</th></tr><tr><td><strong style="color:red;">Акция до 31.10.2014</strong></td><td class="tarif_table_column">0 руб. в год</td><td class="tarif_table_column"><strong>3900 руб. в год</strong></td><td class="tarif_table_column"><strong>9900 руб. в год</strong></td></tr><tr><td>Страниц в поисковиках, шт. 2 До 15 До 100</td><td class="tarif_table_column">2</td><td class="tarif_table_column">до 15</td><td class="tarif_table_column">до 100</td></tr><tr><td><strong>Размещение 1 или более товаров в сервисе Товар дня на<br>главной странице сайта</strong></td><td></td><td></td><td class="tarif_table_column_plus">+</td></tr><tr><td><strong>Каталог акционных товаров, возможность заказа (фото,<br>описание товаров, старая и новая цена), до 12 шт.</strong></td><td></td><td></td><td class="tarif_table_column_plus">+</td></tr><tr><td>Сквозной баннер на главной странице в ротации</td><td></td><td></td><td class="tarif_table_column_plus">+</td></tr><tr><td>Блок- баннер на главной странице сайта</td><td></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td><strong>Фото, картинки, Фотогалерея, до 30 шт.</strong></td><td></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td><strong>Новости, статьи<br>- На страницах компаний<br>- На гл.странице в блоке «новости»</strong></td><td></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td>Форма заказа</td><td></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td>Видео, до 10 роликов</td><td></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td>Метка на карте</td><td class="tarif_table_column">Нет гарантии</td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td>Обновление информации</td><td class="tarif_table_column">Нет гарантии</td><td class="tarif_table_column">От 1 мес.</td><td class="tarif_table_column">От 1 недели</td></tr><tr><td>Размещение на домене третьего уровня</td><td></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td><strong>Поддержание информации в актуальном и полном <br>состоянии: наш менеджер связывается с вами по телефону<br>или электронной почте</strong></td><td></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td><strong>Оптимизация вашей страницы для продвижения в<br>интернете, чтобы вас могло найти как можно больше<br>клиентов через поисковые системы.</strong></td><td></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td><strong>Подбор ключевых слов и написание уникального контента.<br>Т.е. при наличии уникального контента ваша<br>страница попадает в поисковые системы и вас могут найти<br>клиенты через них. Иначе, вашу информацию могут найти<br>только на портале.</strong></td><td></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td><strong>Предложения<br>(информация о скидках, акциях, дисконтных картах,<br>подарочных сертификатах, новинках)</strong></td><td class="tarif_table_column">3 шт.</td><td class="tarif_table_column">12 шт.</td><td class="tarif_table_column">более 12 шт.</td></tr><tr><td>Общая электронная рассылка на e-mail</td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr><td><strong>Размещение информации<br>(Логотип, фото компании, слоган, название,<br>Адреса,телефоны, e-mail, сайт,время работы, проезд,<br>бренды</strong></td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td><td class="tarif_table_column_plus">+</td></tr><tr>
    <td></td>
    <td class="tarif_table_column">
      <a href="http://company.'.$domain.'/users/sign_up">
        <img src="http://s1.skidki-yola.ru/fileadmin/templates/main/img/zakaz.png"></img>
      </a>
    </td>
    <td class="tarif_table_column">
      <a href="http://company.'.$domain.'/users/sign_up">
  ...
  $result =  Array("response" => $tarif_blank);
	#echo date('y.m.d H.i.s', strtotime('now'));
  echo $_GET['callback']."(".json_fix_cyr(json_encode($tarif_blank)).");";
	break;
